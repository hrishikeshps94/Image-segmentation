...
def gen_targets(ann, crop_shape, **kwargs):
    ...
    hv_map = cropping_center(hv_map, crop_shape) # UPDATED THIS DON'T KNOW THE REPERCUSSIONS
...
def prep_sample(data, is_batch=False, **kwargs):
    ...
    def prep_one_sample(data):
        ...
        shape = np.maximum(*shape_array[:2]) # UPDATED THIS DON'T KNOW THE REPERCUSSIONS
        viz_list = []
