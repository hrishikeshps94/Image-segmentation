...
run_info['dir_path'] = {'train':['/media/hrishi/data/WORK/RESEARCH/2022/ISBI-2022/ds/CoNIC_Challenge/train'],\
'valid':['/media/hrishi/data/WORK/RESEARCH/2022/ISBI-2022/ds/CoNIC_Challenge/val']}
run_info['optimizer'] = optim.Adam
run_info['lr_scheduler'] = lambda x: optim.lr_scheduler.StepLR(x, 25)
run_info['loss'] = {"np": {"bce": 1, "dice": 1},"hv": {"mse": 1, "msge": 1},"tp": {"bce": 1, "dice": 1},}
run_info['target_info'] = {"gen": (gen_targets, {}), "viz": (prep_sample, {})}
run_info['batch_size'] = {"train": 1, "valid": 2,}
